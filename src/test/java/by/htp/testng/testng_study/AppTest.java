...
public class AppTest {
	...
	public void test4() {
		...
		element.click();
		element = driver.findElement(By.cssSelector("#profile-privacy-form > div.title"));
		element.click();
		element = driver.findElement(By.cssSelector("#profile-notifications-form > div.title"));
		element.click();
		element = driver.findElement(By.cssSelector("#profile-notifications-form > div.content > form > label.notifications > input[type=\"checkbox\"]"));
		element.click();
		element = driver.findElement(By.cssSelector("#profile-notifications-form > div.content > form > label.deliveries > input[type=\"checkbox\"]"));
		element.click();
		element = driver.findElement(By.cssSelector("#profile-notifications-form > div.content > form > div > input"));
		element.click();
		element = driver.findElement(By.cssSelector("#middle > div.user > div.personal > div.login > div > a"));
		element.click();
		element = driver.findElement(By.cssSelector("#profile-privacy-form > div.title"));
		element.click();
		element = driver.findElement(By.cssSelector("#profile-privacy-form > div.content > form > table > tbody > tr:nth-child(4) > td:nth-child(1) > label > input[type=\"radio\"]"));
		element.click();
		element = driver.findElement(By.cssSelector("#profile-privacy-form > div.content > form > div > input"));
		element.click();
	} 
